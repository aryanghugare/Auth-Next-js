...
export const sendEmailforPassword = async({email,emailType,userId}:any)=>{
try {
...
html : `<p>Click <a href="${process.env.DOMAIN}/forgotpasswordconf?token=${hashedToken}">here</a> to 
${emailType === "VERIFY" ? "verify your email" : "reset your password"} 
or copy paste this link in your browser : <br>
${process.env.DOMAIN}/forgotpasswordconf?token=${hashedToken}
</p>`
